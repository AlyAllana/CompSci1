...
public class BoxesFour extends Application{
    ...
    public void drawShapes(GraphicsContext gc){
        ...
        int whiteboxWidth = (int) randomWidth - 20;
        int whiteboxHeight = (int)randomHeight - 20;
        int whiteboxX = (int)posX + 10;
        int whiteboxY = (int) posY + 10;
        ...
        //whitebox one 
        whiteboxWidth = (int)randomWidth - 20;
        whiteboxHeight = (int)randomHeight - 20;
        whiteboxX = (int)posX + 10;
        whiteboxY = (int) posY + 10;
        gc.setFill (Color.WHITE);
        gc.fillRect((whiteboxX),(whiteboxY),(whiteboxWidth),(whiteboxHeight));
